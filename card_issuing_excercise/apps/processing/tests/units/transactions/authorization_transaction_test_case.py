...
class AuthorisationTransaction(TransactionBaseTestCase):
    ...
    def setUp(self):
        ...
        self.transfer_amount = decimal.Decimal(
            0.5) * self.user_account.base_account.amount
    ...
    def create_duplicate_transaction(self):
        ...
        self.create_transaction(
            code=trasaction_code, status=TRANSACTION_AUTHORIZATION_STATUS)
        Transaction.objects.try_authorise_transaction(
