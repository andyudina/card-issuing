''' Tests Schema Webhook for authorization transction'''
...
from card_issuing_excercise.apps.utils.tests import ShemaWebHookBaseTestCase


class AuthorizationRequest(ShemaWebHookBaseTestCase):
    ...
    def create_duplicate_transaction_by_request(self):
        ...
        return self.create_authorization_transaction_by_request(
    ...
    def test__valid_authorization_request__base_amount_deducted(self):
        self.create_authorization_transaction_by_request()
