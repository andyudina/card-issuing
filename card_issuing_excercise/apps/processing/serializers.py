...
from card_issuing_excercise.apps.processing.models.accounts import CARD_ID_LENGTH
from card_issuing_excercise.apps.processing.models.transactions import TRANSACTION_ID_LENGTH
