...
class Transfer(models.Model):
    ...
    i.e. for each Transaction, the total debits equalthe total credits of Transfers.
    '''

    # TODO: consistency checks for transfer

    transaction = models.ForeignKey(
        'Transaction', related_name='transfers', verbose_name='Transaction')
    # Foreign key is already index in mysql -- so no db_index needed
